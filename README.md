# portfolio-template
Note: 🚧 This project is currently a Work In Progress. I'm actively adding new sections and refining the UI.
 A modern, responsive landing page template built with Tailwind CSS and Vite.


## 🗺️ Roadmap
This project is currently under active development. Below is the roadmap for planned features and improvements:

### Phase 1: Foundation & Layout (Completed 🏗️)
- [x] Initial project setup with Tailwind CSS
- [x] Navigation bar with Login button
- [x] Hero section with background image and overlay
- [x] Sidebar layout for secondary content
